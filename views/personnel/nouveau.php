...
<div class="main-content">
    <div class="container-fluid py-4">
        ...
        <div class="card">
            <div class="card-body">
                <form method="post" action="?page=personnel&action=enregistrer">
                    <div class="row">
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <input class="form-control" name="salaire" type="number" step="0.01" />
                        </div>
                    </div>

                    <div class="mt-3">
                        <button class="btn btn-primary" type="submit">Enregistrer</button>
                        <a class="btn btn-secondary" href="?page=personnel">Annuler</a>
                    </div>
                </form>
            </div>
        </div>
