...
$canCreate = $_SESSION['user_permissions']['medicament']['create'] ?? false;
?>

<div class="main-content">
    <div class="container-fluid py-4">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h4 class="fw-bold"><i class="bi bi-capsule me-2"></i>Gestion des Médicaments</h4>
            <?php if ($canCreate): ?>
            <a href="?page=medicament&action=nouveau" class="btn btn-primary">
                <i class="bi bi-plus-lg me-2"></i>Nouveau Médicament
            </a>
            <?php endif; ?>
        </div>
